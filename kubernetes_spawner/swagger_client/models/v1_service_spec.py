...
class V1ServiceSpec(object):
    ...
    """
    def __init__(self, ports=None, selector=None, cluster_ip=None, type=None, external_i_ps=None, deprecated_public_i_ps=None, session_affinity=None, load_balancer_ip=None):
        """
