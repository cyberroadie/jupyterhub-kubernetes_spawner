...
------------ | ------------- | ------------- | -------------
**capacity** | [**Any**](Any.md) | A description of the persistent volume&#39;s resources and capacity. More info: http://releases.k8s.io/release-1.2/docs/user-guide/persistent-volumes.md#capacity | [optional] 
