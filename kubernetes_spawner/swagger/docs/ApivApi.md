# swagger_client.ApivApi

All URIs are relative to *https://10.10.10.10:443/*

Method | HTTP request | Description
------------- | ------------- | -------------
[**connect_delete_namespaced_node_proxy**](ApivApi.md#connect_delete_namespaced_node_proxy) | **DELETE** /api/v1/nodes/{name}/proxy | connect DELETE requests to proxy of Node
[**connect_delete_namespaced_node_proxy_0**](ApivApi.md#connect_delete_namespaced_node_proxy_0) | **DELETE** /api/v1/nodes/{name}/proxy/{path} | connect DELETE requests to proxy of Node
...
[**connect_get_namespaced_node_proxy**](ApivApi.md#connect_get_namespaced_node_proxy) | **GET** /api/v1/nodes/{name}/proxy | connect GET requests to proxy of Node
[**connect_get_namespaced_node_proxy_0**](ApivApi.md#connect_get_namespaced_node_proxy_0) | **GET** /api/v1/nodes/{name}/proxy/{path} | connect GET requests to proxy of Node
...
[**connect_head_namespaced_node_proxy**](ApivApi.md#connect_head_namespaced_node_proxy) | **HEAD** /api/v1/nodes/{name}/proxy | connect HEAD requests to proxy of Node
[**connect_head_namespaced_node_proxy_0**](ApivApi.md#connect_head_namespaced_node_proxy_0) | **HEAD** /api/v1/nodes/{name}/proxy/{path} | connect HEAD requests to proxy of Node
...
[**connect_options_namespaced_node_proxy**](ApivApi.md#connect_options_namespaced_node_proxy) | **OPTIONS** /api/v1/nodes/{name}/proxy | connect OPTIONS requests to proxy of Node
[**connect_options_namespaced_node_proxy_0**](ApivApi.md#connect_options_namespaced_node_proxy_0) | **OPTIONS** /api/v1/nodes/{name}/proxy/{path} | connect OPTIONS requests to proxy of Node
...
[**connect_post_namespaced_node_proxy**](ApivApi.md#connect_post_namespaced_node_proxy) | **POST** /api/v1/nodes/{name}/proxy | connect POST requests to proxy of Node
[**connect_post_namespaced_node_proxy_0**](ApivApi.md#connect_post_namespaced_node_proxy_0) | **POST** /api/v1/nodes/{name}/proxy/{path} | connect POST requests to proxy of Node
...
[**connect_put_namespaced_node_proxy**](ApivApi.md#connect_put_namespaced_node_proxy) | **PUT** /api/v1/nodes/{name}/proxy | connect PUT requests to proxy of Node
[**connect_put_namespaced_node_proxy_0**](ApivApi.md#connect_put_namespaced_node_proxy_0) | **PUT** /api/v1/nodes/{name}/proxy/{path} | connect PUT requests to proxy of Node
...
[**create_namespaced_namespace**](ApivApi.md#create_namespaced_namespace) | **POST** /api/v1/namespaces | create a Namespace
[**create_namespaced_node**](ApivApi.md#create_namespaced_node) | **POST** /api/v1/nodes | create a Node
[**create_namespaced_persistent_volume**](ApivApi.md#create_namespaced_persistent_volume) | **POST** /api/v1/persistentvolumes | create a PersistentVolume
...
[**delete_namespaced_namespace**](ApivApi.md#delete_namespaced_namespace) | **DELETE** /api/v1/namespaces/{name} | delete a Namespace
[**delete_namespaced_node**](ApivApi.md#delete_namespaced_node) | **DELETE** /api/v1/nodes/{name} | delete a Node
[**delete_namespaced_persistent_volume**](ApivApi.md#delete_namespaced_persistent_volume) | **DELETE** /api/v1/persistentvolumes/{name} | delete a PersistentVolume
...
[**deletecollection_namespaced_namespace**](ApivApi.md#deletecollection_namespaced_namespace) | **DELETE** /api/v1/namespaces | delete collection of Namespace
[**deletecollection_namespaced_node**](ApivApi.md#deletecollection_namespaced_node) | **DELETE** /api/v1/nodes | delete collection of Node
[**deletecollection_namespaced_persistent_volume**](ApivApi.md#deletecollection_namespaced_persistent_volume) | **DELETE** /api/v1/persistentvolumes | delete collection of PersistentVolume
...
[**list_config_map**](ApivApi.md#list_config_map) | **GET** /api/v1/configmaps | list or watch objects of kind ConfigMap
[**list_endpoints**](ApivApi.md#list_endpoints) | **GET** /api/v1/endpoints | list or watch objects of kind Endpoints
[**list_event**](ApivApi.md#list_event) | **GET** /api/v1/events | list or watch objects of kind Event
[**list_limit_range**](ApivApi.md#list_limit_range) | **GET** /api/v1/limitranges | list or watch objects of kind LimitRange
[**list_namespaced_component_status**](ApivApi.md#list_namespaced_component_status) | **GET** /api/v1/componentstatuses | list objects of kind ComponentStatus
...
[**list_namespaced_namespace**](ApivApi.md#list_namespaced_namespace) | **GET** /api/v1/namespaces | list or watch objects of kind Namespace
[**list_namespaced_node**](ApivApi.md#list_namespaced_node) | **GET** /api/v1/nodes | list or watch objects of kind Node
[**list_namespaced_persistent_volume**](ApivApi.md#list_namespaced_persistent_volume) | **GET** /api/v1/persistentvolumes | list or watch objects of kind PersistentVolume
...
[**list_persistent_volume_claim**](ApivApi.md#list_persistent_volume_claim) | **GET** /api/v1/persistentvolumeclaims | list or watch objects of kind PersistentVolumeClaim
[**list_pod**](ApivApi.md#list_pod) | **GET** /api/v1/pods | list or watch objects of kind Pod
[**list_pod_template**](ApivApi.md#list_pod_template) | **GET** /api/v1/podtemplates | list or watch objects of kind PodTemplate
[**list_replication_controller**](ApivApi.md#list_replication_controller) | **GET** /api/v1/replicationcontrollers | list or watch objects of kind ReplicationController
[**list_resource_quota**](ApivApi.md#list_resource_quota) | **GET** /api/v1/resourcequotas | list or watch objects of kind ResourceQuota
[**list_secret**](ApivApi.md#list_secret) | **GET** /api/v1/secrets | list or watch objects of kind Secret
[**list_service**](ApivApi.md#list_service) | **GET** /api/v1/services | list or watch objects of kind Service
[**list_service_account**](ApivApi.md#list_service_account) | **GET** /api/v1/serviceaccounts | list or watch objects of kind ServiceAccount
...
[**patch_namespaced_namespace**](ApivApi.md#patch_namespaced_namespace) | **PATCH** /api/v1/namespaces/{name} | partially update the specified Namespace
[**patch_namespaced_node**](ApivApi.md#patch_namespaced_node) | **PATCH** /api/v1/nodes/{name} | partially update the specified Node
[**patch_namespaced_persistent_volume**](ApivApi.md#patch_namespaced_persistent_volume) | **PATCH** /api/v1/persistentvolumes/{name} | partially update the specified PersistentVolume
...
[**proxy_delete_namespaced_node**](ApivApi.md#proxy_delete_namespaced_node) | **DELETE** /api/v1/proxy/nodes/{name} | proxy DELETE requests to Node
[**proxy_delete_namespaced_node_0**](ApivApi.md#proxy_delete_namespaced_node_0) | **DELETE** /api/v1/proxy/nodes/{name}/{path} | proxy DELETE requests to Node
...
[**proxy_get_namespaced_node**](ApivApi.md#proxy_get_namespaced_node) | **GET** /api/v1/proxy/nodes/{name} | proxy GET requests to Node
[**proxy_get_namespaced_node_0**](ApivApi.md#proxy_get_namespaced_node_0) | **GET** /api/v1/proxy/nodes/{name}/{path} | proxy GET requests to Node
...
[**proxy_head_namespaced_node**](ApivApi.md#proxy_head_namespaced_node) | **HEAD** /api/v1/proxy/nodes/{name} | proxy HEAD requests to Node
[**proxy_head_namespaced_node_0**](ApivApi.md#proxy_head_namespaced_node_0) | **HEAD** /api/v1/proxy/nodes/{name}/{path} | proxy HEAD requests to Node
...
[**proxy_options_namespaced_node**](ApivApi.md#proxy_options_namespaced_node) | **OPTIONS** /api/v1/proxy/nodes/{name} | proxy OPTIONS requests to Node
[**proxy_options_namespaced_node_0**](ApivApi.md#proxy_options_namespaced_node_0) | **OPTIONS** /api/v1/proxy/nodes/{name}/{path} | proxy OPTIONS requests to Node
...
[**proxy_post_namespaced_node**](ApivApi.md#proxy_post_namespaced_node) | **POST** /api/v1/proxy/nodes/{name} | proxy POST requests to Node
[**proxy_post_namespaced_node_0**](ApivApi.md#proxy_post_namespaced_node_0) | **POST** /api/v1/proxy/nodes/{name}/{path} | proxy POST requests to Node
...
[**proxy_put_namespaced_node**](ApivApi.md#proxy_put_namespaced_node) | **PUT** /api/v1/proxy/nodes/{name} | proxy PUT requests to Node
[**proxy_put_namespaced_node_0**](ApivApi.md#proxy_put_namespaced_node_0) | **PUT** /api/v1/proxy/nodes/{name}/{path} | proxy PUT requests to Node
...
[**read_namespaced_component_status**](ApivApi.md#read_namespaced_component_status) | **GET** /api/v1/componentstatuses/{name} | read the specified ComponentStatus
...
[**read_namespaced_namespace**](ApivApi.md#read_namespaced_namespace) | **GET** /api/v1/namespaces/{name} | read the specified Namespace
[**read_namespaced_node**](ApivApi.md#read_namespaced_node) | **GET** /api/v1/nodes/{name} | read the specified Node
[**read_namespaced_persistent_volume**](ApivApi.md#read_namespaced_persistent_volume) | **GET** /api/v1/persistentvolumes/{name} | read the specified PersistentVolume
...
[**replace_namespaced_namespace**](ApivApi.md#replace_namespaced_namespace) | **PUT** /api/v1/namespaces/{name} | replace the specified Namespace
[**replace_namespaced_namespace_finalize**](ApivApi.md#replace_namespaced_namespace_finalize) | **PUT** /api/v1/namespaces/{name}/finalize | replace finalize of the specified Namespace
[**replace_namespaced_namespace_status**](ApivApi.md#replace_namespaced_namespace_status) | **PUT** /api/v1/namespaces/{name}/status | replace status of the specified Namespace
[**replace_namespaced_node**](ApivApi.md#replace_namespaced_node) | **PUT** /api/v1/nodes/{name} | replace the specified Node
[**replace_namespaced_node_status**](ApivApi.md#replace_namespaced_node_status) | **PUT** /api/v1/nodes/{name}/status | replace status of the specified Node
[**replace_namespaced_persistent_volume**](ApivApi.md#replace_namespaced_persistent_volume) | **PUT** /api/v1/persistentvolumes/{name} | replace the specified PersistentVolume
...
[**replace_namespaced_persistent_volume_status**](ApivApi.md#replace_namespaced_persistent_volume_status) | **PUT** /api/v1/persistentvolumes/{name}/status | replace status of the specified PersistentVolume
...
[**watch_config_map_list**](ApivApi.md#watch_config_map_list) | **GET** /api/v1/watch/configmaps | watch individual changes to a list of ConfigMap
[**watch_endpoints_list**](ApivApi.md#watch_endpoints_list) | **GET** /api/v1/watch/endpoints | watch individual changes to a list of Endpoints
[**watch_event_list**](ApivApi.md#watch_event_list) | **GET** /api/v1/watch/events | watch individual changes to a list of Event
[**watch_limit_range_list**](ApivApi.md#watch_limit_range_list) | **GET** /api/v1/watch/limitranges | watch individual changes to a list of LimitRange
...
[**watch_namespaced_namespace**](ApivApi.md#watch_namespaced_namespace) | **GET** /api/v1/watch/namespaces/{name} | watch changes to an object of kind Namespace
[**watch_namespaced_namespace_list**](ApivApi.md#watch_namespaced_namespace_list) | **GET** /api/v1/watch/namespaces | watch individual changes to a list of Namespace
[**watch_namespaced_node**](ApivApi.md#watch_namespaced_node) | **GET** /api/v1/watch/nodes/{name} | watch changes to an object of kind Node
[**watch_namespaced_node_list**](ApivApi.md#watch_namespaced_node_list) | **GET** /api/v1/watch/nodes | watch individual changes to a list of Node
[**watch_namespaced_persistent_volume**](ApivApi.md#watch_namespaced_persistent_volume) | **GET** /api/v1/watch/persistentvolumes/{name} | watch changes to an object of kind PersistentVolume
...
[**watch_namespaced_persistent_volume_list**](ApivApi.md#watch_namespaced_persistent_volume_list) | **GET** /api/v1/watch/persistentvolumes | watch individual changes to a list of PersistentVolume
...
[**watch_persistent_volume_claim_list**](ApivApi.md#watch_persistent_volume_claim_list) | **GET** /api/v1/watch/persistentvolumeclaims | watch individual changes to a list of PersistentVolumeClaim
[**watch_pod_list**](ApivApi.md#watch_pod_list) | **GET** /api/v1/watch/pods | watch individual changes to a list of Pod
[**watch_pod_template_list**](ApivApi.md#watch_pod_template_list) | **GET** /api/v1/watch/podtemplates | watch individual changes to a list of PodTemplate
[**watch_replication_controller_list**](ApivApi.md#watch_replication_controller_list) | **GET** /api/v1/watch/replicationcontrollers | watch individual changes to a list of ReplicationController
[**watch_resource_quota_list**](ApivApi.md#watch_resource_quota_list) | **GET** /api/v1/watch/resourcequotas | watch individual changes to a list of ResourceQuota
[**watch_secret_list**](ApivApi.md#watch_secret_list) | **GET** /api/v1/watch/secrets | watch individual changes to a list of Secret
[**watch_service_account_list**](ApivApi.md#watch_service_account_list) | **GET** /api/v1/watch/serviceaccounts | watch individual changes to a list of ServiceAccount
[**watch_service_list**](ApivApi.md#watch_service_list) | **GET** /api/v1/watch/services | watch individual changes to a list of Service
...
try: 
    ...
    print "Exception when calling ApivApi->connect_delete_namespaced_node_proxy: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_delete_namespaced_node_proxy_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_get_namespaced_node_proxy: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_get_namespaced_node_proxy_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_head_namespaced_node_proxy: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_head_namespaced_node_proxy_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_options_namespaced_node_proxy: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_options_namespaced_node_proxy_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_post_namespaced_node_proxy: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_post_namespaced_node_proxy_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_put_namespaced_node_proxy: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->connect_put_namespaced_node_proxy_0: %s\n" % e
```
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Binding() # V1Binding | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1ConfigMap() # V1ConfigMap | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Endpoints() # V1Endpoints | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Event() # V1Event | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1LimitRange() # V1LimitRange | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Namespace() # V1Namespace | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
try: 
    ...
    print "Exception when calling ApivApi->create_namespaced_namespace: %s\n" % e
```
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Node() # V1Node | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
try: 
    ...
    print "Exception when calling ApivApi->create_namespaced_node: %s\n" % e
```
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1PersistentVolume() # V1PersistentVolume | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
try: 
    ...
    print "Exception when calling ApivApi->create_namespaced_persistent_volume: %s\n" % e
```
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1PersistentVolumeClaim() # V1PersistentVolumeClaim | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Pod() # V1Pod | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1PodTemplate() # V1PodTemplate | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1ReplicationController() # V1ReplicationController | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1ResourceQuota() # V1ResourceQuota | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Secret() # V1Secret | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Service() # V1Service | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1ServiceAccount() # V1ServiceAccount | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1DeleteOptions() # V1DeleteOptions | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
...
try: 
    ...
    print "Exception when calling ApivApi->delete_namespaced_namespace: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->delete_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->delete_namespaced_persistent_volume: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->deletecollection_namespaced_namespace: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->deletecollection_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->deletecollection_namespaced_persistent_volume: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_config_map: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_endpoints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_event: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_limit_range: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_namespaced_component_status: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_namespaced_namespace: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_namespaced_persistent_volume: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_persistent_volume_claim: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_pod: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_pod_template: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_replication_controller: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_resource_quota: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_secret: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_service: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_service_account: %s\n" % e
```
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.UnversionedPatch() # UnversionedPatch | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
name = 'name_example' # str | name of the ConfigMap
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
try: 
    ...
    print "Exception when calling ApivApi->patch_namespaced_namespace: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->patch_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->patch_namespaced_persistent_volume: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_delete_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_delete_namespaced_node_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_get_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_get_namespaced_node_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_head_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_head_namespaced_node_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_options_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_options_namespaced_node_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_post_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_post_namespaced_node_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_put_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->proxy_put_namespaced_node_0: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->read_namespaced_component_status: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->read_namespaced_namespace: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->read_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->read_namespaced_persistent_volume: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->replace_namespaced_namespace: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->replace_namespaced_namespace_finalize: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->replace_namespaced_namespace_status: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->replace_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->replace_namespaced_node_status: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->replace_namespaced_persistent_volume: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->replace_namespaced_persistent_volume_status: %s\n" % e
```
...
# create an instance of the API class
api_instance = swagger_client.ApivApi()
body = swagger_client.V1Scale() # V1Scale | 
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
name = 'name_example' # str | name of the Scale
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
try: 
    ...
    print "Exception when calling ApivApi->watch_config_map_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_endpoints_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_event_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_limit_range_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_namespaced_namespace: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_namespaced_namespace_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_namespaced_node: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_namespaced_node_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_namespaced_persistent_volume: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_namespaced_persistent_volume_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_persistent_volume_claim_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_pod_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_pod_template_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_replication_controller_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_resource_quota_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_secret_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_service_account_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_service_list: %s\n" % e
```
